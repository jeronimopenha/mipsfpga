...
public class Altera_Debug extends hades.models.rtlib.GenericRtlibObject {

    protected Port port_KEY0, port_KEY1, port_KEY2, port_KEY3;  //keys de seleção
    protected Port port_VIN;                                    //switches de valor
    protected Port port_CLKP, port_PC, port_RA, port_RD, port_MA, port_MD;
...
*/
    ...
    public void evaluate(Object arg) {
        ...
        if (signal_KEY0 == null) {
            return;
        } else if (signal_KEY1 == null) {
            return;
        } else if (signal_KEY2 == null) {
            return;
        } else if (signal_KEY3 == null) {
            return;
        } else if (signal_VIN == null) {
            return;
        } else if (signal_RD == null) {
            return;
        } else if (signal_MD == null) {
            return;
        }
